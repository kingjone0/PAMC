...
def mnist_dataset_read(data_dir, batch_size, client_num_in_total, partition, alpha, logger, save_path=None, load_path=None):
    ...
    for i in range(client_num_in_total):
        ...
        train_dataset_client = MNIST_Truncated(
        ...
        val_dataset_client = MNIST_Truncated(
